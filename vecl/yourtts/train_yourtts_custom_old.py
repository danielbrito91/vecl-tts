...
from vecl.yourtts.config_loader import load_and_update_config
from vecl.yourtts.dataset import (
    compute_speaker_embeddings,
    prepare_dataset_configs,
)
from vecl.yourtts.s3_trainer import S3Trainer
from vecl.yourtts.vits_custom import VitsCustom
...
if __name__ == '__main__':
    ...
    model = VitsCustom.init_from_config(
        config,
    ...
    if 'emb_l.weight' in model_state_dict:
        print(
            '    > Removing language embedding layer from checkpoint due to size mismatch.'
        )
